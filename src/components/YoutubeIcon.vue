<template>
  <svg viewBox="0 0 98 24" preserveAspectRatio="xMidYMid meet" focusable="false" @click="$router.push('/')">
    <g viewBox="0 0 98 24" preserveAspectRatio="xMidYMid meet" class="style-scope yt-icon">
      <g class="style-scope yt-icon">
        ...
        <polygon fill="#FFFFFF" points="11.83,16.29 19.25,12 11.83,7.71" class="style-scope yt-icon"></polygon>
      </g>
